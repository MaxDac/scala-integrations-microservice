...
assemblyOutputPath in assembly := new sbt.File(s"${projectDir.get}/out/artifacts/eng.db.integrations.jar")
...
libraryDependencies ++= Seq(
    ...
    "com.eng.db" %% "eng.db.shared" % "0.1" from s"$baseDir/shared/out/artifacts/eng.db.shared.jar"
)
